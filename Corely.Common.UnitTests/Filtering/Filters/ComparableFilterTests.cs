...
public class ComparableFilterTests
{
    ...
    public void Where_WithNonMemberAccessSelector_ThrowsArgumentException()
    {
        var ex = Assert.Throws<ArgumentException>(
            () => Filter.For<TestEntity>().Where(e => int.Parse("20"), ComparableFilter<int>.Equals(20))
        );
    ...
    public void NotEquals_ExcludesExactValue()
    {
        ...
        Assert.All(results, e => Assert.NotEqual(20, e.Age));
    }
    ...
    public void GreaterThan_FiltersAboveThreshold()
    {
        ...
        var results = ApplyFilter(builder);
        Assert.Equal(2, results.Count);
        Assert.All(results, e => Assert.True(e.Age > 15));
    }
    ...
    public void GreaterThanOrEqual_FiltersAtOrAboveThreshold()
    {
        ...
        var results = ApplyFilter(builder);
        Assert.Equal(2, results.Count);
        Assert.All(results, e => Assert.True(e.Age >= 20));
    }
    ...
    public void LessThan_FiltersBelowThreshold()
    {
        ...
        var results = ApplyFilter(builder);
        Assert.Equal(2, results.Count);
        Assert.All(results, e => Assert.True(e.Age < 25));
    }
    ...
    public void Between_FiltersInclusiveRange()
    {
        ...
        var results = ApplyFilter(builder);
        Assert.Equal(2, results.Count);
        Assert.All(results, e => Assert.True(e.Age >= 10 && e.Age <= 20));
    }
    ...
    public void NotBetween_FiltersOutsideRange()
    {
        ...
        var results = ApplyFilter(builder);
        Assert.Equal(2, results.Count);
        Assert.All(results, e => Assert.True(e.Age < 15 || e.Age > 25));
    }
    ...
    public void In_FiltersToValueSet()
    {
        ...
        var results = ApplyFilter(builder);
        Assert.Equal(2, results.Count);
        Assert.All(results, e => Assert.True(e.Age == 10 || e.Age == 30));
    }
    ...
    public void IsNull_FiltersNullableToNull()
    {
        ...
        var results = ApplyFilter(builder);
        var result = Assert.Single(results);
        Assert.Null(result.NullableAge);
    }
    ...
    public void IsNotNull_FiltersNullableToNonNull()
    {
        ...
        var results = ApplyFilter(builder);
        Assert.Equal(2, results.Count);
        Assert.All(results, e => Assert.NotNull(e.NullableAge));
    }
    ...
    public void WorksWithDecimal()
    {
        ...
        var results = ApplyFilter(builder);
        Assert.Equal(2, results.Count);
        Assert.All(results, e => Assert.True(e.Price > 2.00m));
    }
